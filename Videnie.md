...
:Арендатор: --> (Система управления жильём) : Ищет и бронирует жильё
:Собственник: --> (Система управления жильём) : Публикует объявления и управляет бронированиями
:Системный администратор: --> (Система управления жильём) : Настраивает и поддерживает систему
...
(Система управления жильём) --> :Юридическая система: : Синхронизирует данные о договорах
(Система управления жильём) --> :Финансовая система: : Передаёт данные для обработки платежей
